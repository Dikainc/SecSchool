...
namespace EnterpriseSchool.Data
{
    public class Repository : IRepository, IDisposable
    {
        private bool disposed = false;
        protected School_DbEntities context;

        public Repository() : this(new School_DbEntities()) { }

        public Repository(School_DbEntities _context)
        {
            context = _context;
        }
